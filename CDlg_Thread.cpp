...
void CDlg_Thread::OnBnClickedBtnTest3()  //timer start
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}


void CDlg_Thread::OnBnClickedBtnTest4()
{	//HANDLE h1 = AfxBeginThread(td_test1, pdata, THREAD_PRIORITY_NORMAL, 0, 0, NULL);
	m_hThd1 = (CTD_test*)AfxBeginThread(RUNTIME_CLASS(CTD_test), THREAD_PRIORITY_NORMAL, 0, 0);
	m_hThd1->m_id =m_tdID++;
	//m_hThd1->m_id = 1;
	//m_hThd1->Startup(this, "");
}
